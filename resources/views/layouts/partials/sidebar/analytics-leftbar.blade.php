        ...
        <div class="leftbar-tab-menu">
            <div class="main-icon-menu">
                <a href="{{ URL::asset('analytics/analytics-index')}}" class="logo logo-metrica d-block text-center">
                    <span>
                        <img src="{{ URL::asset('assets/images/logo-1.png')}}" alt="logo-small" class="logo-sm">
                    </span>
                </a>
                <nav class="nav">
                    <a href="#MetricaAnalytics" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Dashboard" data-trigger="hover">
            ...
            <div class="main-menu-inner">
                ...
                <div class="menu-body slimscroll">
                    <div id="MetricaAnalytics" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Admin Panel</h6>
                        </div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="/analytics/analytics-index">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="/analytics/analytics-customers">Users</a></li>
