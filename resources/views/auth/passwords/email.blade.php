                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    <div class="auth-logo-box">
                                        <a href="/" class="logo logo-admin"><img src="{{ URL::asset('assets/images/icons8-gift.png') }}" height="55" alt="logo" class="auth-logo"></a>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        @csrf
                                ...
                                <div class="m-3 text-center text-muted">
                                    <p class="">Back to login ?  <a href="{{ route('login') }}" class="text-primary ml-2">Login Now</a></p>
                                </div>
                                </div><!--end /div-->
                            </div><!--end card-body-->
                        </div><!--end card-->
